	...
	<div class="preview">
		<div
			...
			:style="{
				...
				filter: `brightness(${(modelValue.keyIntensity / 100) * (modelValue.keyEnabled ? 1 : 0)})`,
			}"
		>
		...
		<div
			...
			:style="{
				...
				filter: `brightness(${(modelValue.fillIntensity / 100) * (modelValue.fillEnabled ? 1 : 0)})`,
			}"
		>
		...
		<div
			...
			:style="{
				...
				filter: `brightness(${(modelValue.backIntensity / 100) * (modelValue.backEnabled ? 1 : 0)})`,
			}"
		>
